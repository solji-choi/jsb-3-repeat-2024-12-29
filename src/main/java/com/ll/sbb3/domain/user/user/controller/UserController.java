...
public class UserController {
    ...
    public String signup(
        ...
        if(bindingResult.hasErrors()) return "/domain/user/user/signup_form";
        ...
        try {
            this.userService.signup(userCreateForm.username, userCreateForm.password1, userCreateForm.email);
